 ...
 * @LastEditTime: 2023-02-22 18:28:23
 */
...
export const http = {
	...
	postForm<T = any>(url: string, params?: object, config?: AxiosRequestConfig): Promise<T> {
		return service(
			Object.assign(
				{
					method: 'post',
	...
	postJson<T = any>(url: string, params?: object, config?: AxiosRequestConfig): Promise<T> {
		return service(
			Object.assign(
				{
					method: 'post',
